...
void intialization1() {
    ...
    for (int i = 0; i < number_particles; i++) //loop for intializing the value of velocities
    {
        ...
        {
            velocity1[i][j] = (double)(2 * (rand() / RAND_MAX) - 1);
        }
    }
}
...
void intialization2() {
    ...
    for (int i = 0; i < number_particles; i++) //loop for intializing the value of velocities
    {
        ...
        for (int j = 0; j < 2; j++) //loop for dimensionality
        {
            velocity2[i][j] = (double)(2 * (rand() / RAND_MAX) - 1);
        }
    }
}
/*******Rescaling The Velocity*******/
...
void intialization3() {
    ...
    for (int i = 0; i < number_particles; i++) //loop for intializing the value of velocities
    {
        ...
        for (int j = 0; j < 2; j++) //loop for dimensionality
        {
            velocity3[i][j] = (double)(2 * (rand() / RAND_MAX) - 1);
        }
    }
}
/*******Rescaling The Velocity*******/
...
int main() {
    ...
    FILE * fp = fopen("KE.txt", "w");
    FILE * fp1 = fopen("PE.txt", "w");
    FILE * fp2 = fopen("TE.txt", "w");
